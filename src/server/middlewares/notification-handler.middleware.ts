...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Course Addition.create': {
    roles: ['school-owner', 'school-administrator', 'teacher'],
    key: 'course_addition',
    tenantPath: [],
    userPath: [],
  },
  ...
  'Staff Availability Update.update': {
    roles: ['school-owner', 'school-administrator'],
    key: 'staff_availability_update',
    tenantPath: [],
    userPath: [],
  },
};
...
const tenantRoles: string[] = ['school-owner', 'school-administrator', 'teacher', 'staff', 'parent'];
