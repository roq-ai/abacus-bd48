...
import { getSchoolOwnerById } from 'apiSdk/school-owners';
import { SchoolOwnerInterface } from 'interfaces/school-owner';

function SchoolOwnerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('school_owner', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/school-owners/edit/${id}`} passHref legacyBehavior>
                    <Button
