  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Abacus - Empowering educators with smart solutions. A teacher management application designed to streamline processes, foster collaboration, and enhance productivity."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1659301254614-8d6a9d46f26a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHx0ZWFjaGVyfGVufDB8fHx8MTY5Njc3MTAwNHww&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@lexscope?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`LexScope`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Abacus - Empowering educators with smart solutions. A teacher management application designed to streamline processes, foster collaboration, and enhance productivity.`}
            </Text>
            <Box
